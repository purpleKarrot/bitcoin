...
inline bool DeploymentActiveAfter(AnyChainView chain, const Consensus::Params& params, Consensus::BuriedDeployment dep)
{
    assert(Consensus::ValidDeployment(dep));
    return static_cast<int>(chain.size()) >= params.DeploymentHeight(dep);
}
