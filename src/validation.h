...
bool ContextualCheckBlockHeader(const CBlockHeader& block, BlockValidationState& state, const Consensus::Params& consensusParams, AnyChainView chain, NodeClock::time_point now) EXCLUSIVE_LOCKS_REQUIRED(::cs_main);
