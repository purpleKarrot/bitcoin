...
bool ContextualCheckBlockHeader(const CBlockHeader& block, BlockValidationState& state, const Consensus::Params& consensusParams, AnyChainView chain) EXCLUSIVE_LOCKS_REQUIRED(::cs_main);
