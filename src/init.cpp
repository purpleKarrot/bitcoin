...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-mempoolexpiry=<n>", "Deprecated. Transaction expiry from the mempool has been removed. This option has no effect.", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::OPTIONS);
...
bool AppInitParameterInteraction(const ArgsManager& args)
{
    ...
    if (args.IsArgSet("-mempoolexpiry")) {
        InitWarning(_("Option '-mempoolexpiry' is set but transaction expiry from the mempool has been removed. This option has no effect."));
    }
